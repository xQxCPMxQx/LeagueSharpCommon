...
namespace LeagueSharp.Common
{
    ...
    {
        internal static Font Font, FontTitle;
    ...
    public class MenuItem
    {
        ...
        public MenuItem(string name, string displayName, bool makeChampionUniq = false,
            MenuItemType menuItemType = MenuItemType.Standart)
        {
            if (makeChampionUniq)
            {
                name = ObjectManager.Player.ChampionName + name;
        ...
        internal void Drawing_OnDraw()
        {
            ...
            var font = MenuItemType == MenuItemType.Title ? MenuDrawHelper.FontTitle : MenuDrawHelper.Font;
            var fontColor = MenuItemType == MenuItemType.Title
